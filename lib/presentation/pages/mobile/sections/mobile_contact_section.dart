...
class MobileContactSection extends StatelessWidget {
  const MobileContactSection({required this.content, super.key});
        ...
        return MobileSurface(
          ...
          child: AutofillGroup(
            child: Column(
              ...
              children: [
                _ContactField(
                  key: ValueKey('mobile-name-${state.formRevision}'),
                  label: 'Full name',
                  hint: 'e.g. John Doe',
                ...
                _ContactField(
                  key: ValueKey('mobile-email-${state.formRevision}'),
                  label: 'Email address',
                ...
                const SizedBox(height: 17),
                _ContactField(
                  key: ValueKey('mobile-subject-${state.formRevision}'),
                  label: 'Subject',
                ...
                const SizedBox(height: 17),
                _ContactField(
                  key: ValueKey('mobile-message-${state.formRevision}'),
                  label: 'Message',
