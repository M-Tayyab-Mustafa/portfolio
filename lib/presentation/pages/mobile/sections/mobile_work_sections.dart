...
import 'package:portfolio/presentation/pages/mobile/widgets/mobile_project_card.dart';
...
class MobileProjectsSection extends StatelessWidget {
  const MobileProjectsSection({required this.content, super.key});
                        ...
                        for (final entry in projects.indexed)
                          SizedBox(
                            ...
                            child: RevealOnScroll(
                              ...
                              child: MobileProjectCard(project: entry.$2),
                            ),
                          ),
                      ],
                    );
...
class MobileExperienceSection extends StatelessWidget {
  const MobileExperienceSection({required this.content, super.key});
...
class MobileTestimonialsSection extends StatefulWidget {
  const MobileTestimonialsSection({required this.content, super.key});

  final PortfolioDataState content;

  @override
  State<MobileTestimonialsSection> createState() =>
...
class _MobileTestimonialsSectionState extends State<MobileTestimonialsSection> {
  ...
  @override
  void didUpdateWidget(covariant MobileTestimonialsSection oldWidget) {
